            ...
            <nav  className="navigation_categories mt-5" >
                <div className="navigation_category mb-4">
                    ...
                    <ul className="navbar-nav mx-auto">
                        <li className="nav-item "> <a className="nav-link text-secondary " href="/">Introduction to React and MDX</a></li>
                        <li className="nav-item"> <a className="nav-link text-secondary" href="/Installation">Setting up a React Project</a></li>
                    </ul>
                </div>
                <div className="navigation_category mb-4">
